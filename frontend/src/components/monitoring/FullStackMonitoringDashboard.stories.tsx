...
export const DashboardInAsciiTheme: Story = {
  decorators: [
    (Story) => {
      try {
        localStorage.setItem('portfolio_theme', 'ascii');
      } catch {
        // ignore
      }
      return (
...
export const DashboardInCliTheme: Story = {
  decorators: [
    (Story) => {
      try {
        localStorage.setItem('portfolio_theme', 'cli');
      } catch {
        // ignore
      }
      return (
