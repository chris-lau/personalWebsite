...
- [ ] Add `id="ask-this-site"` to chat exhibit section in `HomePage.tsx`
- [ ] Tighten hero vertical spacing in mobile media queries in `Pages.css` (≤768px)
- [ ] Verify no desktop regression at 1440×800
- [ ] Create E2E test `home-fold.spec.ts` (if port 3000 free)
- [ ] Run unit tests and lint before commits
